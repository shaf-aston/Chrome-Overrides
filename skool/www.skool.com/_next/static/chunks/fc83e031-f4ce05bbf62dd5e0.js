    ...
    [6911], {
        84348: function(e, t, n) {
            ...
            let b = "undefined" != typeof navigator ? navigator : null,
                ...
                O = !!(N || C || D),
                S = N ? document.documentMode : C ? +C[1] : D ? +D[1] : 0,
                M = !O && /gecko\/(\d+)/i.test(w);
            M && (/Firefox\/(\d+)/.exec(w) || [0, 0])[1];
            let x = !O && /Chrome\/(\d+)/.exec(w),
                k = !!x,
                T = x ? +x[1] : 0,
                E = !O && !!b && /Apple Computer/.test(b.vendor),
            ...
            function I(e, t, n) {
                ...
                for (let r = n || e.dom; r; r = l(r)) {
                    ...
                    let e = r,
                        ...
                        d = 0,
                        a = 0;
                    if (t.top < l.top + z(o, "top") ? a = -(l.top - t.top + z(i, "top")) : t.bottom > l.bottom - z(o, "bottom") && (a = t.bottom - t.top > l.bottom - l.top ? t.top + z(i, "top") - l.top : t.bottom - l.bottom + z(i, "bottom")), t.left < l.left + z(o, "left") ? d = -(l.left - t.left + z(i, "left")) : t.right > l.right - z(o, "right") && (d = t.right - l.right + z(i, "right")), d || a) {
            ...
            class eo extends ee {
                ...
                static create(e, t, n, o) {
                    let s = o.nodeViews[t.type.name],
                        r = s && s(t, o, n);
                    return r && r.dom || (r = i.PW.renderSpec(document, t.type.spec.toDOM(t, n))), new eo(e, t, r.dom, r.contentDOM || r.dom)
                }
                parseRule() {
            ...
            function eD(e, t = !1) {
                ...
                if (eM(e, n), ew(e)) {
                    ...
                    if (e.domObserver.disconnectSelection(), e.cursorWrapper) {
                        let t, n, o, i;
                        t = e.domSelection(), n = document.createRange(), (i = "IMG" == (o = e.cursorWrapper.dom).nodeName) ? n.setEnd(o.parentNode, r(o) + 1) : n.setEnd(o, 0), n.collapse(!1), t.removeAllRanges(), t.addRange(n), !i && !e.state.selection.visible && O && S <= 11 && (o.disabled = !0, o.disabled = !1)
                    } else {
                        let i, s, r, l, {
                                anchor: d,
                                head: a
            ...
            function eC(e, t) {
                ...
                if (E && i && "false" == i.contentEditable) return eO(i);
            ...
            function eV(e, t, n) {
                ...
                if (i instanceof o.Bs) {
                    ...
                    if (!(A && n.indexOf("m") > -1)) {
                        ...
                        return !!(s.isAtom || (r = e.docView.descAt(l)) && !r.contentDOM) && (o.qv.isSelectable(s) ? eA(e, new o.qv(t < 0 ? e.state.doc.resolve(n.pos - s.nodeSize) : n)) : !!B && eA(e, new o.Bs(e.state.doc.resolve(t < 0 ? l : l + s.nodeSize))))
                    }
                } else {
            ...
            eZ.keydown = (e, t) => {
                if (e.input.shiftKey = 16 == t.keyCode || t.shiftKey, !te(e, t) && (e.input.lastKeyCode = t.keyCode, e.input.lastKeyCodeTime = Date.now(), !R || !k || 13 != t.keyCode)) {
                    if (229 != t.keyCode && e.domObserver.forceFlush(), !P || 13 != t.keyCode || t.ctrlKey || t.altKey || t.metaKey) e.someProp("handleKeyDown", n => n(e, t)) || function(e, t) {
                        ...
                        if (40 == o || A && 78 == o && "c" == i) return function(e) {
            ...
            eQ.mousedown = (e, t) => {
                ...
                let r = ti(e),
                    l = Date.now(),
                    d = "singleClick";
                l - e.input.lastClick.time < 500 && (i = (n = e.input.lastClick).x - t.clientX) * i + (s = n.y - t.clientY) * s < 100 && !t[e4] && ("singleClick" == e.input.lastClick.type ? d = "doubleClick" : "doubleClick" == e.input.lastClick.type && (d = "tripleClick")), e.input.lastClick = {
                    time: l,
                    x: t.clientX,
                    y: t.clientY,
                    type: d
                ...
                a && ("singleClick" == d ? (e.input.mouseDown && e.input.mouseDown.done(), e.input.mouseDown = new e7(e, a, t, !!r)) : ("doubleClick" == d ? function(e, t, n, o) {
                    ...
                    return e8(e, "handleTripleClickOn", t, n, i) || e.someProp("handleTripleClick", n => n(e, t, i)) || function(e, t, n) {
                        ...
                        let i = e.state.doc;
                        if (-1 == t) return !!i.inlineContent && (e9(e, o.Bs.create(i, 0, i.content.size), "pointer"), !0);
                        let s = i.resolve(t);
                        for (let t = s.depth + 1; t > 0; t--) {
                            let n = t > s.depth ? s.nodeAfter : s.node(t),
                                r = s.before(t);
                            if (n.inlineContent) e9(e, o.Bs.create(i, r + 1, r + 1 + n.content.size), "pointer");
                            else {
                                if (!o.qv.isSelectable(n)) continue;
                                e9(e, o.qv.create(i, r), "pointer")
                            }
                            return !0
                        }
                    }(e, n, i)
                })(e, a.pos, a.inside, t) ? t.preventDefault() : e2(e, "pointer"))
            };
            class e7 {
                constructor(e, t, n, i) {
                    let s, r;
                    if (this.view = e, this.pos = t, this.event = n, this.flushed = i, this.delayedSelectionSync = !1, this.mightDrag = null, this.startDoc = e.state.doc, this.selectNode = !!n[e4], this.allowDefault = n.shiftKey, t.inside > -1) s = e.state.doc.nodeAt(t.inside), r = t.inside;
                    else {
                ...
                up(e) {
                    ...
                    if (this.view.state.doc != this.startDoc && (t = this.view.posAtCoords(e6(e))), this.updateAllowDefault(e), this.allowDefault || !t) e2(this.view, "pointer");
                        ...
                        (n = this.view, i = t.pos, s = t.inside, r = this.selectNode, e8(n, "handleClickOn", i, s, e) || n.someProp("handleClick", t => t(n, i, e)) || (r ? function(e, t) {
                            ...
                            return null != s && (e9(e, o.qv.create(e.state.doc, s), "pointer"), !0)
                        }(n, s) : function(e, t) {
                            if (-1 == t) return !1;
                            let n = e.state.doc.resolve(t),
                                i = n.nodeAfter;
                            return !!(i && i.isAtom && o.qv.isSelectable(i)) && (e9(e, new o.qv(n), "pointer"), !0)
                        }(n, s))) ? e.preventDefault(): 0 == e.button && (this.flushed || E && this.mightDrag && !this.mightDrag.node.isAtom || k && !this.view.state.selection.visible && 2 >= Math.min(Math.abs(t.pos - this.view.state.selection.from), Math.abs(t.pos - this.view.state.selection.to))) ? (e9(this.view, o.Y1.near(this.view.state.doc.resolve(t.pos)), "pointer"), e.preventDefault()) : e2(this.view, "pointer")
                    }
                }
                move(e) {
            ...
            eZ.compositionstart = eZ.compositionupdate = e => {
                if (!e.composing) {
                    ...
                    if (t.selection.empty && (t.storedMarks || !n.textOffset && n.parentOffset && n.nodeBefore.marks.some(e => !1 === e.type.spec.inclusive))) e.markCursor = e.state.storedMarks || n.marks(), ti(e, !0), e.markCursor = null;
                    else if (ti(e), M && t.selection.empty && n.parentOffset && !n.textOffset && n.nodeBefore.marks.length) {
                        let t = e.domSelectionRange();
            ...
            for (let e in eQ.dragstart = (e, t) => {
                    ...
                    t.dataTransfer.clearData(), t.dataTransfer.setData(ts ? "Text" : "text/html", d.innerHTML), t.dataTransfer.effectAllowed = "copyMove", ts || t.dataTransfer.setData("text/plain", a), e.dragging = new td(c, !t[ta], n)
                }, eQ.dragend = e => {
                    let t = e.dragging;
                    window.setTimeout(() => {
                        e.dragging == t && (e.dragging = null)
                    }, 50)
                }, eZ.dragover = eZ.dragenter = (e, t) => t.preventDefault(), eZ.drop = (e, t) => {
                    let n = e.dragging;
            ...
            class ty {
                ...
                static create(e, t) {
                    return t.length ? tC(t, e, 0, tg) : tb
                }
                find(e, t, n) {
                    let o = [];
                ...
                mapInner(e, t, n, o, i) {
                    ...
                    return this.children.length ? function(e, t, n, o, i, s, r) {
                        ...
                        if (d) {
                            let d = tC(function(e, t, n, o, i, s, r) {
                        ...
                        return new ty(t.sort(tO), l)
                    }(this.children, s || [], e, t, n, o, i) : s ? new ty(s.sort(tO), tm) : tb
                }
                add(e, t) {
                ...
                addInner(e, t, n) {
                    ...
                    e.forEach((e, s) => {
                        ...
                        if (l = tD(t, e, r)) {
                            ...
                            o[i] == s ? o[i + 2] = o[i + 2].addInner(e, l, r + 1) : o.splice(i, 0, s, s + e.nodeSize, tC(l, e, r + 1, tg)), i += 3
                        }
                    });
                    let s = tw(i ? tN(t) : t, -n);
                    for (let t = 0; t < s.length; t++) s[t].type.valid(e, s[t]) || s.splice(t--, 1);
                    return new ty(s.length ? this.local.concat(s).sort(tO) : this.local, o || this.children)
                }
                remove(e) {
            ...
            ty.empty = new ty([], []), ty.removeOverlap = tS;
            let tb = ty.empty;
            class tv {
                constructor(e) {
                    this.members = e
            ...
            function tC(e, t, n, o) {
                ...
                t.forEach((t, r) => {
                    ...
                    if (l) {
                        s = !0;
                        let e = tC(l, t, n + r + 1, o);
                        e != tb && i.push(r, r + t.nodeSize, e)
                    }
                });
                let r = tw(s ? tN(e) : e, -n).sort(tO);
            ...
            class tP {
                ...
                flush() {
                    ...
                    let a = null;
                    s < 0 && i && e.input.lastFocus > Date.now() - 200 && Math.max(e.input.lastTouch, e.input.lastClick.time) < Date.now() - 300 && g(n) && (a = ev(e)) && a.eq(o.Y1.near(e.state.doc.resolve(0), 1)) ? (e.input.lastFocus = 0, eD(e), this.currentSelection.set(n), e.scrollToSelection()) : (s > -1 || i) && (s > -1 && (e.docView.markDirty(s, r), tA.has(e) || (tA.set(e, null), -1 === ["normal", "nowrap", "pre-line"].indexOf(getComputedStyle(e.dom).whiteSpace)) || (e.requiresGeckoHackNode = M, tV || (console.warn("ProseMirror expects the CSS white-space property to be set, preferably to 'pre-wrap'. It is recommended to load style/prosemirror.css from the prosemirror-view package."), tV = !0))), this.handleDOMChange(s, r, l, d), e.docView && e.docView.dirty ? e.updateState(e.state) : this.currentSelection.eq(n) || eD(e), this.currentSelection.set(n))
                }
            ...
            class tF {
                constructor(e, t) {
                    this._root = null, this.focused = !1, this.trackWrites = null, this.mounted = !1, this.markCursor = null, this.cursorWrapper = null, this.lastSelectedViewDesc = void 0, this.input = new e1, this.prevDirectPlugins = [], this.pluginViews = [], this.requiresGeckoHackNode = !1, this.dragging = null, this._props = t, this.state = t.state, this.directPlugins = t.plugins || [], this.directPlugins.forEach(t_), this.dispatch = this.dispatch.bind(this), this.dom = e && e.mount || document.createElement("div"), e && (e.appendChild ? e.appendChild(this.dom) : "function" == typeof e ? e(this.dom) : e.mount && (this.mounted = !0)), this.editable = tW(this), t$(this), this.nodeViews = tH(this), this.docView = es(this.state.doc, tK(this), tx(this), this.dom, this), this.domObserver = new tP(this, (e, t, n, s) => (function(e, t, n, s, r) {
                            ...
                            if ((P && e.input.lastIOSEnter > Date.now() - 225 || R) && r.some(e => 1 == e.nodeType && !tq.test(e.nodeName)) && (!N || N.endA >= N.endB) && e.someProp("handleKeyDown", t => t(e, y(13, "Enter")))) {
                                e.input.lastIOSEnter = 0;
                                return
                            }
                            if (!N) {
                                if (s && b instanceof o.Bs && !b.empty && b.$head.sameParent(b.$anchor) && !e.composing && !(v.sel && v.sel.anchor != v.sel.head)) N = {
                                    start: b.from,
                                    endA: b.to,
                                    endB: b.to
                                };
                            ...
                            if ((P && e.input.lastIOSEnter > Date.now() - 225 && (!T || r.some(e => "DIV" == e.nodeName || "P" == e.nodeName)) || !T && C.pos < v.doc.content.size && !C.sameParent(M) && (a = o.Y1.findFrom(v.doc.resolve(C.pos + 1), 1, !0)) && a.head == M.pos) && e.someProp("handleKeyDown", t => t(e, y(13, "Enter")))) {
                                e.input.lastIOSEnter = 0;
                                return
                            }
                            if (e.state.selection.anchor > N.start && function(e, t, n, o, i) {
                                ...
                                }(w, N.start, N.endA, C, M) && e.someProp("handleKeyDown", t => t(e, y(8, "Backspace")))) {
                                R && k && e.domObserver.suppressSelectionUpdates();
                                return
                            }
                            k && R && N.endB == N.start && (e.input.lastAndroidDelete = Date.now()), R && !T && C.start() != M.start() && 0 == M.parentOffset && C.depth == M.depth && v.sel && v.sel.anchor == v.sel.head && v.sel.head == N.endA && (N.endB -= 2, M = v.doc.resolveNoCache(N.endB - v.from), setTimeout(() => {
                            ...
                            let E = N.start,
                                A = N.endA;
                            if (T) {
                                if (C.pos == M.pos) O && S <= 11 && 0 == C.parentOffset && (e.domObserver.suppressSelectionUpdates(), setTimeout(() => eD(e), 20)), c = e.state.tr.delete(E, A), h = w.resolve(N.start).marksAcross(w.resolve(N.endA));
                            ...
                            if (c || (c = e.state.tr.replace(E, A, v.doc.slice(N.start - v.from, N.endB - v.from))), v.sel) {
                                ...
                                t && !(k && R && e.composing && t.empty && (N.start != N.endB || e.input.lastAndroidDelete < Date.now() - 100) && (t.head == E || t.head == c.mapping.map(A) - 1) || O && t.empty && t.head == E) && c.setSelection(t)
                            }
                            ...
                            for (let t in eQ) {
                                ...
                                e.dom.addEventListener(t, e.input.eventHandlers[t] = t => {
                                    ! function(e, t) {
                                        ...
                                        return !0
                                    }(e, t) || e5(e, t) || !e.editable && t.type in eZ || n(e, t)
                                }, e0[t] ? {
                                    passive: !0
                                } : void 0)
                            }
                ...
                updateStateInner(e, t) {
                    ...
                    if (d) {
                        ...
                        let a = g && (O || k) && !this.composing && !s.selection.empty && !e.selection.empty && (o = s.selection, i = e.selection, d = Math.min(o.$anchor.sharedDepth(o.head), i.$anchor.sharedDepth(i.head)), o.$anchor.start(d) != i.$anchor.start(d));
                        if (g) {
                ...
                endOfTextblock(e, t) {
                    ...
                    return n = this, o = t || this.state, i = e, J == o && Q == i ? Z : (J = o, Q = i, Z = "up" == i || "down" == i ? (s = o.selection, r = "up" == i ? s.$from : s.$to, j(n, o, () => {
                        ...
                        let i = o.parentOffset,
                            ...
                            r = e.domSelection();
                        return X.test(o.parent.textContent) && r.modify ? j(e, t, () => {
                            let {
                                focusNode: t,
                                focusOffset: i,
                                anchorNode: s,
                ...
                domSelectionRange() {
                    ...
                    return E && 11 === this.root.nodeType && function(e) {
            ...
            function t$(e) {
                if (e.markCursor) {
                    ...
                    t.className = "ProseMirror-separator", t.setAttribute("mark-placeholder", "true"), t.setAttribute("alt", ""), e.cursorWrapper = {
                        dom: t,
                        deco: tp.widget(e.state.selection.head, t, {
                            raw: !0,
                            marks: e.markCursor
                        })
                    }
